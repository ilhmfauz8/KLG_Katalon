...
try {
	...
	'User input with blank credentials'
	WebUI.click(findTestObject('Login Page/textfield_username'))
	WebUI.setText(findTestObject('Login Page/textfield_username'), '')
	WebUI.click(findTestObject('Login Page/textfield_password'))
	WebUI.setEncryptedText(findTestObject('Login Page/textfield_password'), '')
	...
	WebUI.delay(1)
	WebUI.verifyElementPresent(findTestObject('Login Page/alert_invalidCredentials'),1)
